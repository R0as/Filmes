...
<body>
    <header class="header">
        <nav class="navbar">
            <h6 class="name-site">Filmes do ben10</h6>
            <ul class="nav-list">
                <li><a class="btn-nav efeito" href="{{ route('movie.index') }}">Inicio</a></li>
                <li> <a class="btn-nav efeito" href="{{ route('movie.create') }}">Criar filme</a></li>
            </ul>
        </nav>
    </header>
